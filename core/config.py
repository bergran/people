...
DATABASES = {
    ...
    'database': os.environ.get('DATABASE', 'people'),
    'username': os.environ.get('USERNAME', 'people'),
    'password': os.environ.get('PASSWORD', 'people'),
...
RESOURCE_PLACES_NUMBER_ELEMENTS = int(os.getenv('RESOURCE_NUMBER_ELEMENTS', 20))
