...
This is a people microservices, have some crud people.

### Diagram
 
![Diagram](./people%20diagram.png)
...
```bash
      ...
      Port: Database port
      RESOURCE_PLACES_NUMBER_ELEMENTS: This is the number of places to randomize it on create dummy data.
